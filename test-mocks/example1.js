module.exports = function(angular) {
    ...
    function NoDependenciesService() {
        return noopService;
    }

    function OneAngularDependencyService1($http) {
        return noopService;
    }

    function MixedDependenciesService1($http, ServiceX, ServiceY) {
        return noopService;
    }
    ...
    var MixedDependenciesService2 = [
        ...
        function($http, ServiceX, ServiceY) {
            return noopService;
        }
    ];
    ...
    function NoDependenciesCtrl() {
        return noopService;
    }

    function OneAngularDependencyCtrl1($http) {
        return noopService;
    }

    function MixedDependenciesCtrl1($http, ServiceX, ServiceY) {
        return noopService;
    }
